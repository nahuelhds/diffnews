...
describe("fetchNewArticles", () => {
  ...
  const saveToJsonFileMock = saveToJsonFile as MockedFunction<
    typeof saveToJsonFile
  >;
  ...
  it("should return a promise", () => {
    ...
    const expectedPath = `${STATIC_FOLDER}/${expectedId}.json`;
    ...
    expect(saveToJsonFileMock).toHaveBeenCalledWith(
      expectedPath,
      MOCKED_FEED_DATA,
    );
  });
